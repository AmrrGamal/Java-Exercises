...
public class Exercise02_10 {
    public static void main(String[] args) {
        ...
        weightWater = input.nextDouble();

        System.out.println("Enter the begin temperature of the water in Celsius");

        Scanner input1 = new Scanner(System.in);
        beginTemperture = input1.nextDouble();
        ...
        double result = weightWater * (finalTemperature - beginTemperture) * 4184;
